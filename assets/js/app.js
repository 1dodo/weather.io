...
export const updateWeather = function (lat, lon) {
    ...
    const highlihtSection = document.querySelector("[data-highlights]");
    const hourlySection = document.querySelector("[data-hourly-forecast]");
    const forecastSection = document.querySelector("[data-5-day-forecast]");

    currentWeatherSection.innerHTML = "";
    highlihtSection.innerHTML = "";
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        fetchData(url.reversoGeo(lat, lon), function ([{ name, country }]) {
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            card.innerHTML = `
            <h2 class="title-2" id="highlihts-label">Todays Highlights</h2>
            ...
            highlihtSection.appendChild(card);
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                    loading="lazy" alt="direction" class="weather-icon" style="transfrom: rotate(${windDirection - 180}deg)">
